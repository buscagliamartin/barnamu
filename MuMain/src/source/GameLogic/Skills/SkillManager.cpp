...
{
    // Iterate the full slot range: skills added client-side (e.g. Earthshake at
    // slot 62, pet commands at slot 120+) live beyond SkillNumber and would never
    // have their delay decremented under the old SkillNumber+2 heuristic.
