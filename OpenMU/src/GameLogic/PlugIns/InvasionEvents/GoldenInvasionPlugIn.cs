...
public class GoldenInvasionPlugIn : BaseInvasionPlugIn<PeriodicInvasionConfiguration>, ISupportDefaultCustomConfiguration
{
    ...
    public GoldenInvasionPlugIn()
        : base(
            ...
            [
                new(GoldenBudgeDragonId, 10, MapId: LorenciaId),
                new(GoldenGoblinId, 8, MapId: NoriaId),
                new(GoldenSoldierId, 8, MapId: DeviasId),
                new(GoldenTitanId, 6, MapId: DeviasId),
                new(GoldenVeparId, 6, MapId: AtlansId),
                new(GoldenLizardKingId, 4, MapId: AtlansId),
                new(GoldenWheelId, 5, MapId: TarkanId),
                new(GoldenTantallosId, 3, MapId: TarkanId),
            ],
            [new(GoldenDragonId, 5)])
    {
    }
