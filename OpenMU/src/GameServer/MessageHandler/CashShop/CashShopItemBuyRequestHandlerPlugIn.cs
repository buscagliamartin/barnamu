...
/// <summary>
/// Handles cash shop buy requests.
/// </summary>
[PlugIn]
[Display(Name = "Cash shop buy handler", Description = "Rejects unsupported cash shop purchases cleanly.")]
[Guid("D97C2E09-164A-49C9-A3F3-F6E555C659F5")]
...
internal class CashShopItemBuyRequestHandlerPlugIn : ISubPacketHandlerPlugIn
{
    ...
    public async ValueTask HandlePacketAsync(Player player, Memory<byte> packet)
    {
        ...
        await connection.SendBuyResultAsync(1).ConfigureAwait(false);
    }
}
