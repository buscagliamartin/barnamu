...
internal partial class NpcInitialization
{
    ...
    protected virtual ItemStorage CreatePasiTheMageStore(short number)
    {
        List<Item> itemList = new ()
        {
            ...
            this.ItemHelper.CreateSetItem(16, 2, ItemGroups.Helm, null, 0, 1, true),    // Pad Helm     +9+4+L
            this.ItemHelper.CreateSetItem(32, 2, ItemGroups.Armor, null, 0, 1, true),    // Pad Armor    +9+4+L
            this.ItemHelper.CreateSetItem(48, 2, ItemGroups.Pants, null, 0, 1, true),    // Pad Pants    +9+4+L
            this.ItemHelper.CreateSetItem(64, 2, ItemGroups.Boots, null, 0, 1, true),   // Pad Boots    +9+4+L
            this.ItemHelper.CreateSetItem(80, 2, ItemGroups.Gloves, null, 0, 1, true),   // Pad Gloves   +9+4+L
